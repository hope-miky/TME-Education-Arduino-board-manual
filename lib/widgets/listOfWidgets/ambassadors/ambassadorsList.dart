...
class _AmbassadorsListViewState extends State<AmbassadorsListView> {
  final ambassadors = [
    ...
    {
      "name": "Eya al Habib",
      "desc": "Eya is a Tunisian engineering student, an ambassador of TME Education and a member of Aerobotix INSAT.",
      "country": "Tunisia",
      "flag": "",
...

    {
      ...
      "desc": "He has a master degree in telecommunication but the list of his qualifications is much, much longer. Nantan’s skills go far beyond electronics and technology as he is a gifted coach that teaches with passion, adding some business twist to the discipline.",
      "country": "Madagascar",
      "flag": "",
    ...
    },
    {
      ...
      "desc": "A student in the department of telecommunication at the Polytechnic school of Antananarivo , she is passionate about technologies, how it can bring evolution into everyone's everyday life. Holitiana really likes making projects which solve the little problems people face every day. In her free time, she enjoys watching movies and exploring the outside world.",
      "country": "Madagascar",
      "flag": "",
    ...
    {
      "name": "Riclin Sasman",
      "desc": "Riclin Sasman, a guy hungry for technology, having more than 15 years experience in research and development. He eats, sleeps and breaths electronics, he has a passion to help educate those, who have limited access to electronics education by granting them an opportunity to learn about technology. Riclin obtained a national certificate in electrical/electronics engineering and mechatronics at the College of Cape Town. He spends his free time with his wife and kid, flying, fishing or looking for new ways to implement technology.",
    ...
    {
      "name": "Patrick Ssonko",
      "desc": "Patrick is TME Education Ambassador in Uganda. He has vast knowledge and considerable experience in electronics, embedded systems design and embedded software development. In 2014 he served as a teaching assistant in the department of computer engineering at Mbarara University of Science and Technology, an institution where he studied himself before. Patrick is passionate about reverse engineering for resource-constrained applications. He likes watching football matches, especially Barcelona and Arsenal. In his free time he enjoys reading and making new friends.",
      "country": "Uganda",
      "flag": "",
    ...
    },
    {
      ...
      "desc": "He is a programmer and electrotechnician. His aim is to promote innovative projects in order to make everyone’s life better. Yannick is a fan of basketball and enjoys spending time in nature.",
      "country": "Cameroon",
      "flag": "",
    ...
    {
      "name": "Loic Dessap",
      "desc": "Loic is TME Education Ambassador in Cameroon. he moment he graduated from National Advanced School of Posts, Telecommunications and Information and Communications Technologies and obtained his bachelor’s degree, he had already gained international experience in various competitions and received several awards outside Cameroon. He is passionate about technology, electronics and education. Loic enjoys constructing and programming electronic circuits, building robots and working with IoT projects. In his free time, he listens to music, does sports and plays video games. Loic likes travelling, sharing his knowledge and ideas with others.",
      "country": "Cameroon",
      "flag": "",
