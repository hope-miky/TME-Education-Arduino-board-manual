          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    " * Simple, single-colour LED (D13).",
                    textAlign: TextAlign.left,
                  ),
                  Text(
                    " * Simple, three-colour (RGB) LED ( D9 - D11).",
                    textAlign: TextAlign.left,
                  ),
                  Text(
                    " * 7-SEG display ",
            ...
            Padding(
              padding: const EdgeInsets.symmetric(vertical: 10, horizontal: 10),
              child: Text(
                "For programming the board you need the Arduino IDE environment, which can be downloaded for free from the project website, i.e.: https://arduino.cc. From the page navigation menu, select the \"SOFTWARE\" tab. On the newly opened page, go to the \"Download the Arduino IDE\" section and select the appropriate version for the given system from the list on the right. Then you will be asked for voluntary financial support for the project. At this stage, you can donate or download the software for free by selecting the \"JUST DOWNLOAD\" button. At this point, the installer will start downloading.",
                textAlign: TextAlign.justify,
              ),
            ),
            Card(
